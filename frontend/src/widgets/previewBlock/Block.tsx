...
import { MImageBlock } from "./ui/ImageBlock";
  ...
  return (
    ...
    >
      ...
      <m.div
        ...
        className="w-full flex flex-col lg:flex-row gap-3 justify-around items-center mt-16"
      >
        <MSubTitle
          id=""
          className={reverse ? "lg:text-main dark:lg:text-dark-main" : ""}
        >
          {subTitle}
        </MSubTitle>
        {first && (
